      ...
      {chart_i && (
        <>
          ...
          <BarChart className="chart" width={250} height={210} data={data}>
            ...
            <Tooltip />
            <Legend />
            <Bar dataKey="Followers" fill="#1f4748" />
            <Bar dataKey="Earnings" fill="#ce4e54" />
          </BarChart>
        </>
      )}
      {chart_ii && (
        ...
        >
          ...
          <Tooltip />
          <Legend />
          <Line type="monotone" dataKey="pv" stroke="#ce4e54" />
          <Line type="monotone" dataKey="uv" stroke="#1f4748" />
        </LineChart>
      )}
      {chart_iii && (
